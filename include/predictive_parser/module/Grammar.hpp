...
static const std::string GRAMMAR_FILE_PATH
  = "input/gramatica_correta.txt"; // Caminho do arquivo de gramática
...
class Grammar {
   std::unordered_map<std::string, std::vector<Production>>
     productionsMap; // Mapa de produções
